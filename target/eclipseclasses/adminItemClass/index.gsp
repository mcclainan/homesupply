                            ...
                            <tbody>
                                <g:each in="${itemClassInstanceList}" var="itemClass">
                                    <tr>
                                        ...
                                        <td><g:link action="edit" id="${itemClass.id}" class="button small special">Edit</g:link> </td>
                                        <td><g:link action="delete" id="${itemClass.id}" class="button small alt" onclick="return confirm('${message(code: 'button.delete.confirm', default: 'Are you sure?')}');">Delete</g:link> </td>
                                    </tr>
                                </g:each>
                            </tbody>
                        <tfoot>
