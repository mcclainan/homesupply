    ...
    <header id="header">
        ...
        <nav id="nav">
            <ul>
                ...
                <sec:ifAnyGranted roles="ROLE_HOME_SUPPLY_USER">
                    <li><g:link controller="request">Requests</g:link></li>
                </sec:ifAnyGranted>
                    <sec:ifAnyGranted roles="ROLE_SHOPPER">
                    <li><g:link controller="shop">Shop</g:link></li>
                </sec:ifAnyGranted>
                <sec:ifAnyGranted roles="ROLE_ADMIN">
                    <li>
                        <g:link controller="adminHome" class="icon fa-angle-down">Admin Home</g:link>
                        <ul>
                            ...
                            <li><g:link controller="adminUser" target="_blank">Users</g:link></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#" class="icon fa-angle-down">Example Pages</a>
                        <ul>
                            <li><g:link uri="/exampleContact">Contact</g:link></li>
                            <li><g:link uri="/exampleElements">Elements</g:link></li>
                            <li><g:link uri="/exampleGeneric">Generic</g:link></li>
                            <li><g:link uri="/exampleIndex">Index</g:link></li>
                        </ul>
                    </li>
                </sec:ifAnyGranted>
                <sec:ifLoggedIn>
                ...
                <sec:ifNotLoggedIn>
                    <li><g:link controller="login" class="button">Login</g:link></li>
                </sec:ifNotLoggedIn>
