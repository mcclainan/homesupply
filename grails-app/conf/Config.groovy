...
//        production {
//            appenders {
//                appender new org.apache.log4j.net.SMTPAppender(name: 'email',
//                        threshold: org.apache.log4j.Level.ERROR,
//                        smtpHost: 'localhost',
//                        to: 'kic-error@ink.org',
//                        subject: "propertytax:err:Application Error",
//                        layout: pattern(conversionPattern: "[%d{ISO8601}] %-5p : %-40c{4} : %m%n")
//                )
//            }
//
//            root {
//                error 'rollingLog', 'email'
//                info 'rollingLog'
//            }
//        }
//
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'org.macsuite.homesupply.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'org.macsuite.homesupply.UserRole'
grails.plugin.springsecurity.authority.className = 'org.macsuite.homesupply.Role'
grails.plugin.springsecurity.logout.postOnly=false
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	'/':                              ['permitAll'],
	'/index':                         ['permitAll'],
	'/exampleIndex':                  ['ROLE_ADMIN'],
	'/exampleElements':               ['ROLE_ADMIN'],
	'/exampleGeneric':                ['ROLE_ADMIN'],
	'/exampleContact':                ['ROLE_ADMIN'],
	'/exampleShopping':               ['ROLE_ADMIN'],
	'/index.gsp':                     ['permitAll'],
	'/assets/**':                     ['permitAll'],
	'/**/js/**':                      ['permitAll'],
	'/**/css/**':                     ['permitAll'],
